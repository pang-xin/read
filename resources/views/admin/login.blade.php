...
<head>
    ...
    <link href="{{asset('/Wechat/css/font-awesome.css?v=4.4.0')}}" rel="stylesheet">
...
<div class="middle-box text-center loginscreen  animated fadeInDown">
    <div>
        ...
        <form class="m-t" role="form" action="{{url('admin/login_do')}}" method="post">
            ...
            <p class="text-muted text-center"> <a href="login.html#"><small>忘记密码了？</small></a> | <a href="{{url('admin/reg')}}">注册一个新账号</a>
            </p>
